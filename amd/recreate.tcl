...
#
# recreate.tcl: Tcl script for re-creating project 'zcu102-blinky'
#
# Generated by Vivado on Tue Feb 02 22:29:17 CET 2021
...
#
#    "/home/leon/sandbox/parretto/zcu102-blinky/src/rtl/blinky.v"
#    "/home/leon/sandbox/parretto/zcu102-blinky/src/rtl/blinky_zcu102.v"
#    "/home/leon/sandbox/parretto/zcu102-blinky/src/xdc/blinky_zcu102.xdc"
#    "/home/leon/sandbox/parretto/zcu102-blinky/amd/zcu102/xdc/zcu102.xdc"
#    "/home/leon/sandbox/parretto/zcu102-blinky/amd/tcl/pre_implementation.tcl"
#    "/home/leon/sandbox/parretto/zcu102-blinky/amd/tcl/pre_bitstream.tcl"
#
#*****************************************************************************************
...
set origin_dir "/home/leon/sandbox/parretto/zcu102-blinky"
...
set _xil_proj_name_ "zcu102-blinky"
...
set orig_proj_dir "[file normalize "$origin_dir/amd/zcu102-blinky"]"
...
set files [list \
 [file normalize "${origin_dir}/src/rtl/blinky.v"] \
 [file normalize "${origin_dir}/src/rtl/blinky_zcu102.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/rtl/blinky.v"
...
set file "$origin_dir/src/rtl/blinky_zcu102.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "blinky_zcu102" -objects $obj
...
set file "[file normalize "$origin_dir/src/xdc/blinky_zcu102.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/xdc/blinky_zcu102.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/amd/zcu102/xdc/zcu102.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/amd/zcu102/xdc/zcu102.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set files [list \
 [file normalize "${origin_dir}/amd/tcl/pre_implementation.tcl"] \
 [file normalize "${origin_dir}/amd/tcl/pre_bitstream.tcl"] \
]
add_files -norecurse -fileset $obj $files

# Set 'utils_1' fileset file properties for remote files
set file "$origin_dir/amd/tcl/pre_implementation.tcl"
set file [file normalize $file]
...
set file "$origin_dir/amd/tcl/pre_bitstream.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
set_property -name "file_type" -value "TCL" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: reset_controller_ddr, and set properties
  set reset_controller_ddr [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 reset_controller_ddr ]
  ...
  # Create instance: system_ila_hpm_lpd, and set properties
  set system_ila_hpm_lpd [ create_bd_cell -type ip -vlnv xilinx.com:ip:system_ila:1.1 system_ila_hpm_lpd ]
  set_property -dict [ list \
   CONFIG.C_MON_TYPE {INTERFACE} \
   CONFIG.C_NUM_MONITOR_SLOTS {1} \
   CONFIG.C_SLOT_0_APC_EN {0} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M01_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI] [get_bd_intf_pins system_ila_ddr/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net user_si570_sysclk_0_1 [get_bd_intf_ports user_si570_sysclk] [get_bd_intf_pins ddr4_0/C0_SYS_CLK]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD] [get_bd_intf_pins system_ila_hpm_lpd/SLOT_0_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_LPD]

  # Create port connections
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins axi_smc/aclk1] [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins reset_controller_ddr/slowest_sync_clk] [get_bd_pins system_ila_ddr/clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins reset_controller_ddr/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins reset_controller_ddr/peripheral_aresetn] [get_bd_pins system_ila_ddr/resetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins reset_controller/peripheral_aresetn] [get_bd_pins system_ila_hpm_lpd/resetn]
  connect_bd_net -net sys_rst_1 [get_bd_ports sys_rst] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins reset_controller/slowest_sync_clk] [get_bd_pins system_ila_hpm_lpd/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins reset_controller/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x90000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/amd/zcu102-blinky/zcu102-blinky.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu102-blinky.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/zcu102-blinky.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "strategy" -value "Vivado Implementation Defaults" -objects $obj
set_property -name "steps.init_design.tcl.pre" -value "[file normalize "$origin_dir/amd/tcl/pre_implementation.tcl"]" -objects $obj
...
set_property -name "steps.write_bitstream.tcl.pre" -value "[file normalize "$origin_dir/amd/tcl/pre_bitstream.tcl"]" -objects $obj
